...
bazel run //data_ingestion:create_raw_programs -- --data_source=other --source_name=eth_py150_open \
...
bazel run //data_ingestion:run_create_queryset -- --labeled_queries_file_path=$(pwd)/$3 \
