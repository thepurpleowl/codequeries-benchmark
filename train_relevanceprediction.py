...
def train_relevance_subsample_ada(train_data, dev_data):
    ...
    for epoch in tqdm(range(EPOCHS)):
        ...
        retain_old = int(total_negative * 0.6)
...
def train_relevance_naive(train_data, dev_data):
    RESULTS_CSV_PATH = 'model_op/rel_subsample_results_naive.csv'
    MODEL_PATH = "model_op/model_rel_subsample_naive"
