...
from basecontexts import Block, CLASS_FUNCTION, MODULE_FUNCTION
...
class TestDistributableQueryContext(unittest.TestCase):
    ...
    def test_relevant_block(self):
        ...
        for i, code in enumerate(SOURCE_CODE):
            span = SPANS[i]
            generated_block = get_span_context('Wrong number of arguments in a call',
